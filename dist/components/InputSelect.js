...
var InputSelect = function (_a) {
    var value = _a.value, onChange = _a.onChange, rightIcon = _a.rightIcon, placeholder = _a.placeholder, items = _a.items, Component = _a.Component, Stub = _a.Stub, _b = _a.minLength, minLength = _b === void 0 ? 3 : _b, checked = _a.checked, checkedIcon = _a.checkedIcon;
    return (react_1.default.createElement("div", { className: "input-select" },
        react_1.default.createElement("div", { className: "input-select__input" },
            react_1.default.createElement(index_1.Input, { value: value, onChange: onChange, placeholder: placeholder, rightIcon: rightIcon })),
